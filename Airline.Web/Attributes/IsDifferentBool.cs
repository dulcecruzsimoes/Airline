...
{
    public class IsDifferentBool : ValidationAttribute, IClientModelValidator
    {
        private readonly string _nomePropriedade;
        private readonly string _nomePropriedadeValidar;

        public IsDifferentBool(string nomePropriedade, string nomePropriedadeValidar)
        {
        ...
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            var propertyString = (bool)property.GetValue(validationContext.ObjectInstance); // Obter o valor que está na propriedade que foi passada
        ...
        {
            return $"Pick a type trip: roundtrip or one way";
        }
